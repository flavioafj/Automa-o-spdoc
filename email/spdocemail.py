...
f = open("C:\\Users\\flavi\\OneDrive\\Documentos\\Automação spdoc\\modelo_consulta.txt", "r", encoding="utf-8")
texto = f.read()
...
#corpo do texto
WebDriverWait(driver, timeout=5).until(lambda e: e.find_element(By.CSS_SELECTOR, '#EditorBody'))
